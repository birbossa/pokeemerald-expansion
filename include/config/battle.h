...
#define B_MINIMIZE_EVASION          GEN_3      // In Gen5+, Minimize raises evasion by 2 stages instead of 1.
...
#define B_FLAG_NO_BAG_USE           FLAG_DISABLE_BAG_USE     // If this flag is set, the ability to use the bag in battle is disabled.
