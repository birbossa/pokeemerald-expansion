...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_COMET_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Punches as fast as a com-\n"
            "et. It always hits first."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_RAZOR_WIND] =
    {
        ...
        .description = COMPOUND_STRING(
            "Blasts target with sharp\n"
            "blades. May cause flinching."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_FLY] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 75 : 75,
        .type = TYPE_FLYING,
        .accuracy = 95,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_VINE_WHIP] =
    {
        ...
        #endif
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 40 : 40,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_JUMP_KICK] =
    {
        ...
        .type = TYPE_FIGHTING,
        .accuracy = 95,
        .pp = B_UPDATED_MOVE_DATA >= GEN_5 ? 10 : 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_TACKLE] =
    {
        ...
        .effect = EFFECT_HIT,
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_5 ? 95 : 95,
        .pp = 35,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_WRAP] =
    {
        ...
        .power = 20,
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_5 ? 90 : 90,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_FLAMETHROWER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "may inflict a burn."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 80 : 80,
        .type = TYPE_FIRE,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SURF] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 75 : 75,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_DRAGON_RAGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Charges and tackles the foe\n"
            "with its body or head."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_SMOG] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 25 : 25,
        .type = TYPE_POISON,
        .accuracy = 75,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SKULL_BASH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "attacks with high recoil."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 130 : 130,
        .type = TYPE_ROCK,
        .accuracy = 85,
        .recoil = 33,
        .pp = B_UPDATED_MOVE_DATA >= GEN_6 ? 10 : 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_LEECH_LIFE] =
    {
        ...
        .effect = EFFECT_ABSORB,
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 70 : 70,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_FLASH] =
    {
        ...
        .power = 40,
        .type = TYPE_STEEL,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_4 ? 100 : 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_ZAP_CANNON] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 150 : 100,
        .type = TYPE_ELECTRIC,
        .accuracy = 50,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_UPROAR] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 60 : 60,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_RANDOM,
    ...
    [MOVE_POISON_FANG] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            ...
            .chance = B_UPDATED_MOVE_DATA >= GEN_6 ? 30 : 30,
        }),
        .contestEffect = CONTEST_EFFECT_WORSEN_CONDITION_OF_PREV_MONS,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
    ...
    [MOVE_BULLET_SEED] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "to strike the foe first."),
        .effect = EFFECT_MULTI_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 10 : 10,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
